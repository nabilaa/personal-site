          ...
          <div className="mx-auto max-w-[1100px]">
            ...
            <div>
              {experiences.map((experience, index) => (
                <article
                  className="relative grid grid-cols-[25px_1fr] gap-[15px] md:grid-cols-[42px_1fr] md:gap-6"
        ...
        {/* Skill Section */}
          ...
          <div className="mx-auto max-w-[1100px]">
            ...
            <div className="grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-5">
              {skills.map((skill) => (
                <div key={skill.id} className="group flex flex-col items-center rounded-lg p-4 text-center transition-colors duration-200 hover:bg-brand-accent">
                  <div className="mb-3 flex h-16 w-16 items-center justify-center rounded-lg">
                    {(() => {
                      const ToolIcon = toolIcons[skill.name]
                      return <ToolIcon className="h-12 w-12 text-brand-accent transition-colors duration-200 group-hover:text-brand-cream" strokeWidth={1.2} aria-hidden="true" />
                    })()}
                  </div>
